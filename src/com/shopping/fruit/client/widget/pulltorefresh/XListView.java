...
//	导航栏显示隐藏开关
//	private static final boolean isScrollHideAndShow = false;
	...
	private void updateHeaderHeight(float delta) {
		...
		Log.i("MyListView", "updateHeaderHeight()-> headerTop: " + headerTop);
	...
	private void resetHeaderHeight() {
		Log.i("XListView", "resetHeaderHeight(): " + "start");
		int height = mHeaderView.getVisiableHeight();
		Log.i("XListView", "resetHeaderHeight()-> height: " + height);
		if (height == 0) // not visible.
			return;
		
		Log.i("XListView", "resetHeaderHeight()-> mPullRefreshing: " + mPullRefreshing);
		Log.i("XListView", "resetHeaderHeight()-> mHeaderViewHeight: " + mHeaderViewHeight);
		...
		mScroller.startScroll(0, height, 0, finalHeight - height,
				SCROLL_DURATION);
		invalidate();
		Log.i("XListView", "resetHeaderHeight(): " + "end");
	}
	...
	public boolean onTouchEvent(MotionEvent ev) {
		...
		default:
			...
			if (getFirstVisiblePosition() == 0) {
				...
				Log.i("XListView", "onTouchEvent: " + "resetHeaderHeight执行了");
				resetHeaderHeight();
			} 
			break;
		}
