...
public interface Page extends View {
   ...
   *
   * @return
   * @see {@link android.content.pm.ActivityInfo#SCREEN_ORIENTATION_PORTRAIT} {@link android.content.pm.ActivityInfo#SCREEN_ORIENTATION_LANDSCAPE}
   */
